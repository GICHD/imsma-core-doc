...
2.  Click **New Survey**.
    ...
    ![image](media/Authoring_Survey123_Forms_and_Data/image1.png)


3.  Enter a title for your survey.

    ![image](media/Authoring_Survey123_Forms_and_Data/image2.png)
...
7.  Click the **Publish** button ![Publishbutton](media/Authoring_Survey123_Forms_and_Data/image3.png)
...
-   Open the Choices sheet.
    ...
    ![image](media/Authoring_Survey123_Forms_and_Data/image4.png)
...
-   Create a list of the choices you'd like the user to choose from. The
    ...
    ![image](media/Authoring_Survey123_Forms_and_Data/image5.png)
...
-   In the type field select the select\_one option and replace
    ...
    ![image](media/Authoring_Survey123_Forms_and_Data/image6.png)
...
![image](media/Authoring_Survey123_Forms_and_Data/image7.png)
...
![image](media/Authoring_Survey123_Forms_and_Data/image8.png)
...
![image](media/Authoring_Survey123_Forms_and_Data/image9.png)
...
![image](media/Authoring_Survey123_Forms_and_Data/image10.png)
...
![image](media/Authoring_Survey123_Forms_and_Data/image11.png)
