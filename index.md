...
## Maps and Apps
  [Authoring Maps on Portal](maa/Authoring_Maps_on_Portal.md)  
  [How to Create a Web App](maa/How_to_Create_a_Web_App.md)  
  [Web App Builder Overview](maa/Web_App_Builder_Overview.md)  
  [Choosing the right Web App Builder Widgets](maa/Choosing_the_Right_Web_App_Builder_Widget.md)  
  [Selecting the Right Web App in Portal](maa/Selecting_the_Right_Web_Application_in_Portal.md)  
  [Copying Web Apps with ArcGIS Online Assistant](maa/Copying_Web_Applications_with_AGO_Assistant.md)  
